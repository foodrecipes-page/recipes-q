...
Recipe cache shard for **[foodrecipes.page](https://foodrecipes.page)** — AI-generated recipes whose slug starts with **the letter 'q'**.
...
```
https://cdn.jsdelivr.net/gh/foodrecipes-page/recipes-q@main/recipes/<cuisine>/<diet>/<slug>.json
```
